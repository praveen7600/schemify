...
# Uncomment and modify the relevant sections based on your dataset needs

# Segment: Student (BC/MBC)
professions = ['student']
...
data = {
    ...
    'scheme': [random.choice(eligible_schemes) for _ in range(num_rows)],
    'link': [random.choice(scheme_links) for _ in range(num_rows)]
}
